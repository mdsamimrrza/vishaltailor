export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 md:h-7 md:w-7 fill-current">

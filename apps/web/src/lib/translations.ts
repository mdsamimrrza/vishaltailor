...
export const translations: TranslationDictionary = {
  ne: {
    ...
    garments_coatpant_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_coatpant_delivery: "१०–१४ दिनमा तयार",
    garments_coatpant_desc: "कार्यालय र औपचारिक अवसरका लागि सन्तुलित काँध, सफा फिनिश र परिष्कृत फिट।",
    garments_safari: "सफारी सूट",
    garments_safari_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_safari_delivery: "७–१० दिनमा तयार",
    ...
    garments_pants_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_pants_delivery: "५–७ दिनमा तयार",
    ...
    garments_kurta_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_kurta_delivery: "४–६ दिनमा तयार",
    garments_kurta_desc: "धार्मिक, पारिवारिक र उत्सवका लागि हल्का, आरामदायी र सुन्दर फिट।",
    garments_sherwani: "शेरवानी",
    garments_sherwani_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_sherwani_delivery: "१४–२१ दिनमा तयार",
    garments_sherwani_desc: "विवाह र विशेष समारोहका लागि भव्य एम्बेलिस्मेन्ट र नापको परिशुद्धता।",
    garments_bandi: "बण्डी",
    garments_bandi_price: "मूल्य अनुरोधमा उपलब्ध",
    garments_bandi_delivery: "१२–१८ दिनमा तयार",
  ...
  hi: {
    ...
    garments_coatpant_price: "कीमत अनुरोध पर उपलब्ध",
    garments_coatpant_delivery: "7–14 दिनों में तैयार",
    garments_coatpant_desc: "ऑफिस और औपचारिक मौकों के लिए संतुलित कंधे, साफ फिनिश और सटीक फिट।",
    garments_safari: "सफारी सूट",
    garments_safari_price: "कीमत अनुरोध पर उपलब्ध",
    garments_safari_delivery: "7–10 दिनों में तैयार",
    garments_safari_desc: "आरामदायक चाल, मजबूत सिल्हुट और शाही प्रस्तुति के लिए क्लासिक लुक।",
    garments_mensdress: "पुरुष ड्रेस",
    garments_pants: "शर्ट और पैंट",
    garments_pants_price: "कीमत अनुरोध पर उपलब्ध",
    garments_pants_delivery: "5–7 दिनों में तैयार",
    garments_pants_desc: "दैनिक इस्तेमाल, ऑफिस और फॉर्मल मुलाकातों के लिए साफ और टिकाऊ सिलाई।",
    garments_jeans: "जींस",
    garments_kurta: "कुर्ता-पायजामा",
    garments_kurta_price: "कीमत अनुरोध पर उपलब्ध",
    garments_kurta_delivery: "4–6 दिनों में तैयार",
    garments_kurta_desc: "धार्मिक, पारिवारिक और उत्सव के लिए हल्का, आरामदायक और सुंदर फिट।",
    garments_sherwani: "शेरवानी",
    garments_sherwani_price: "कीमत अनुरोध पर उपलब्ध",
    garments_sherwani_delivery: "14–21 दिनों में तैयार",
    garments_sherwani_desc: "शादी और विशेष समारोहों के लिए भव्य अलंकरण और नाप की सटीकता।",
    garments_bandi: "बंडी",
    garments_bandi_price: "कीमत अनुरोध पर उपलब्ध",
    garments_bandi_delivery: "12–18 दिनों में तैयार",
  ...
  en: {
    ...
    garments_coatpant_price: "Price available on request",
    garments_coatpant_delivery: "Ready in 10–14 days",
    ...
    garments_safari_price: "Price available on request",
    garments_safari_delivery: "Ready in 7–10 days",
    ...
    garments_pants_price: "Price available on request",
    garments_pants_delivery: "Ready in 5–7 days",
    ...
    garments_kurta_price: "Price available on request",
    garments_kurta_delivery: "Ready in 4–6 days",
    ...
    garments_sherwani_price: "Price available on request",
    garments_sherwani_delivery: "Ready in 14–21 days",
    garments_sherwani_desc: "Grand embellishment and precise measuring for weddings and special ceremonies.",
    garments_bandi: "Bandi",
    garments_bandi_price: "Price available on request",
    garments_bandi_delivery: "Ready in 12–18 days",

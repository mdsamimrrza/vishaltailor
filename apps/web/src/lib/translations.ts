...
export const translations: TranslationDictionary = {
  ne: {
    ...
    catalogue_shirt: "सर्ट",
    catalogue_safari: "सफारी",
    catalogue_kurtapajama: "कुर्ता-पायजामा",
    catalogue_khandress: "खन ड्रेस",
    catalogue_cat_shirt: "सर्ट",
    catalogue_cat_khandress: "खन ड्रेस",
  ...
  hi: {
    ...
    catalogue_sherwani: "शेरवानी",
    catalogue_shirt: "शर्ट",
    catalogue_safari: "सफारी",
    catalogue_kurtapajama: "कुर्ता-पायजामा",
    catalogue_khandress: "खान ड्रेस",
    catalogue_cat_shirt: "शर्ट",
    catalogue_cat_khandress: "खान ड्रेस",
  ...
  en: {
    ...
    catalogue_shirt: "Shirt Collection",
    catalogue_safari: "Safari Collection",
    catalogue_kurtapajama: "Kurta-Pajama Collection",
    catalogue_khandress: "Khan Dress Collection",
    catalogue_cat_shirt: "Shirt",
    catalogue_cat_khandress: "Khan Dress",
    catalogue_page: "Page",
    catalogue_of: "of",
